...
class Seo_Metaboxes {
	...
	*/
	...
	function save_seo_meta_boxes( $post_id ) {
		...
		// Saving SEO Title
		if ( isset( $_POST [ 'seo_title' ] ) && ! empty( $_POST[ 'seo_title' ] ) ) {
			update_post_meta($post_id, '_seo_title', sanitize_text_field($_POST['seo_title']));
		}

		// Saving SEO Meta Description
		if ( isset( $_POST['seo_meta_description']) && ! empty( $_POST[ 'seo_meta_description' ] ) ) {
		...
		if ( isset( $_POST['seo_google_news_keywords'] ) && !empty( $_POST['seo_google_news_keywords'] ) ) {
			update_post_meta( $post_id, '_seo_google_news_keywords', sanitize_text_field( $_POST['seo_google_news_keywords'] ) );
		}
	}
	 ...
	 * @return void.
	 */
	function home_page_seo_meta_data_add_admin_page() {
		add_menu_page(
	 ...
	 * @return void.
	 */
	function home_page_seo_meta_data_settings_page() {
		?>
		<div class="wrap">
	 ...
	 * @return void .
	 */
	function home_page_seo_meta_data_register_settings() {
	...
	*/
	 ...
	 * @return void
	*/
	function seo_keywords_callback() {
	 ...
	 * @return void
	*/
	function seo_description_callback() {
	 ...
	 * @return void
	*/
	function original_title_callback() {
	 ...
	 * @return void
	*/
	function original_description_callback() {
	 ...
	 * @return void
	*/
	function home_page_logo_callback() {
	 ...
	 * @return vod
	*/
	function my_plugin_remove_theme_support() {
		remove_theme_support('title-tag');
	}

	/**
	 * Function to get the feature image details of the particular post id
	 * @input post_id
	 * @return null or array with url,alt,width,height,caption.
	 */
	function get_featured_image_details( $post_id ) {
	...
	function seo_meta_changes() {
		...
		if ( is_single() ) {
			...
			if ( $homepage_logo_image_url_id ) {
				...
				if ( $home_page_logo_details !== null && isset( $home_page_logo_details['alt'] ) ) {
					$homepage_logo_image_url_alt = $home_page_logo_details['alt'];
				}
			}
			echo '<title>'.$home_page_seo_title  .'</title>'. "\n";
			...
			if ( ! empty( $homepage_logo_image_url ) && is_string( $homepage_logo_image_url ) ) {
				...
				if ( $homepage_logo_image_url_alt !== null ) {
